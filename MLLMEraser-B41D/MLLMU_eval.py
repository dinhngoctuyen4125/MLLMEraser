...
def evaluate_classification(parquet_file, few_shot_parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None):
    ...
    print(f"Classification Pure Text Question Accuracy: {pure_text_accuracy:.2f}%")
...
def evaluate_fill_in_the_blank(parquet_file, few_shot_parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None):
    ...
    print(f"Cloze Pure Text Question Accuracy: {pure_text_accuracy:.2f}%")
...
def main():
    ...
    if "forget_test_retain_real" in args.eval_list:
        ...
        print("************************PURE_TEXT RESULT*********************")
        print("************************PURE_TEXT RESULT*********************")
        print("************************PURE_TEXT RESULT*********************")

        print("#######################CLASSIFICATION RESULTS################:")
        print(f"Forget Set Classification pure_text_accuracy:{forget_classification_result['Classification Pure Text Question Accuracy']}")
        print(f"Test Set Classification pure_text_accuracy:{test_classification_result['Classification Pure Text Question Accuracy']}")
        print(f"Retain Set Classification pure_text_accuracy:{retain_classification_result['Classification Pure Text Question Accuracy']}")
        print(f"Real Set Classification pure_text_accuracy:{real_classification_result['Classification Pure Text Question Accuracy']}")

        print("#######################GENERATION RESULTS########################:")
        print(f"Forget Set Average ROUGE-L (Pure_Text):{forget_generation_result['Average ROUGE-L (Pure_Text)']}")
        print(f"Test Set Average ROUGE-L (Pure_Text):{test_generation_result['Average ROUGE-L (Pure_Text)']}")
        print(f"Retain Set Average ROUGE-L (Pure_Text):{retain_generation_result['Average ROUGE-L (Pure_Text)']}")
        print(f"Real Set Average ROUGE-L (Pure_Text):{real_generation_result['Average ROUGE-L (Pure_Text)']}")

        print("#######################CLOZE RESULTS########################:")
        print(f"Forget Set Cloze pure_text_accuracy:{forget_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        print(f"Test Set Cloze pure_text_accuracy:{test_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        print(f"Retain Set Cloze pure_text_accuracy:{retain_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        print(f"Real Set Cloze pure_text_accuracy:{real_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
