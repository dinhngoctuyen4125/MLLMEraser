...
def evaluate_classification(parquet_file, few_shot_parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None, logger=None):
    if id_list_file:
    ...
    for j, row in tqdm(eval_samples.iterrows(), total=len(eval_samples)):
        ...
        for idx, question_data in enumerate(classification_questions.get("Image_Textual_Questions", [])):
            ...
            print("The model answer is: ", correct_answer.lower() in assistant_response.lower())
            print("\n")
    ...
    logger.info(f"Classification Pure Text Question Accuracy: {pure_text_accuracy:.2f}%")

    return {
        "Classification image-textual Question Accuracy": image_textual_accuracy,
        "Classification Pure Text Question Accuracy": pure_text_accuracy
    }


def evaluate_fill_in_the_blank(parquet_file, few_shot_parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None, logger=None):
    ...
    logger.info(f"Cloze Pure Text Question Accuracy: {pure_text_accuracy:.2f}%")

    return {
        "Cloze image_textual_accuracy": image_textual_accuracy,
        "Cloze pure_text_accuracy": pure_text_accuracy
    }
    ...
    for j, row in tqdm(eval_samples.iterrows(), total=len(eval_samples)):
        ...
        for question_data in generation_questions:
            ...
            if question_type == "Image_Textual":
                ...
                print("###### The model answer is: ######",predicted_answer.lower())
                print("\n")
            else:  # Pure_Text case
...
def parse_arguments():
    ...
    parser.add_argument('--eval_list', type=str, required=False, default='generation')
    ...
    parser.add_argument('--cloze_strength', type=float, required=False, default=-0.3)
    parser.add_argument('--generation_strength', type=float, required=False, default=-0.20)
    parser.add_argument('--classification_strength', type=float, required=False, default=-0.20)
...
def main():
    ...
    steering_matrix_path_str = args.steering_matrix_path.split("/")[-1]
    ...
    if "classification" in args.eval_list:
        ...
        forget_classification_result = evaluate_classification(parquet_file=forget_parquet_file,
            few_shot_parquet_file=args.few_shot_data if args.few_shot_data else None,
            processor=processor,
            tokenizer=tokenizer,
            model=model,
            args=args,
        ...
        logger.info("Classification Results Pure Text:")
        logger.info(f"forget_classification_result:{forget_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"test_classification_result:{test_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"retain_classification_result:{retain_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"real_classification_result:{real_classification_result['Classification Pure Text Question Accuracy']}")
    ...
    if "generation" in args.eval_list:
        ...
        logger.info(f"forget_generation_result:{forget_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"test_generation_result:{test_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"retain_generation_result:{retain_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"real_generation_result:{real_generation_result['Average ROUGE-L (Pure_Text)']}")
    ...
    if "cloze" in args.eval_list:
        ...
        logger.info("Cloze Results pure text:")
        logger.info(f"forget_fill_in_the_blank_result:{forget_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        logger.info(f"test_fill_in_the_blank_result:{test_fill_in_the_blank_result['Cloze pure_text_accuracy']    }")
        logger.info(f"retain_fill_in_the_blank_result:{retain_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        logger.info(f"real_fill_in_the_blank_result:{real_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
    ...
    if "classification_generation_cloze" in args.eval_list:
        ...
        logger.info("************************PURE_TEXT RESULT*********************")
        logger.info("************************PURE_TEXT RESULT*********************")
        logger.info("************************PURE_TEXT RESULT*********************")

        logger.info("#######################CLASSIFICATION RESULTS################:")
        logger.info(f"Forget Classification pure_text_accuracy:{forget_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"Test Classification pure_text_accuracy:{test_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"Retain Classification pure_text_accuracy:{retain_classification_result['Classification Pure Text Question Accuracy']}")
        logger.info(f"Real Classification pure_text_accuracy:{real_classification_result['Classification Pure Text Question Accuracy']}") 

        logger.info("#######################GENERATION RESULTS########################:")
        logger.info(f"Forget Average ROUGE-L (Pure_Text):{forget_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"Test Average ROUGE-L (Pure_Text):{test_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"Retain Average ROUGE-L (Pure_Text):{retain_generation_result['Average ROUGE-L (Pure_Text)']}")
        logger.info(f"Real Average ROUGE-L (Pure_Text):{real_generation_result['Average ROUGE-L (Pure_Text)']}")

        logger.info("#######################CLOZE RESULTS########################:")
        logger.info(f"Forget Cloze pure_text_accuracy:{forget_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        logger.info(f"Test Cloze pure_text_accuracy:{test_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        logger.info(f"Retain Cloze pure_text_accuracy:{retain_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
        logger.info(f"Real Cloze pure_text_accuracy:{real_fill_in_the_blank_result['Cloze pure_text_accuracy']}")
